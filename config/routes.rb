Rails.application.routes.draw do
  ...
  get 'member/:id', to: 'members#show', as: 'member' #assigns a name to the route for convenience
  ...
  patch 'update_dpersonal_details', to: 'members#update_personal_details', as: 'update_member_personal_details'
end
